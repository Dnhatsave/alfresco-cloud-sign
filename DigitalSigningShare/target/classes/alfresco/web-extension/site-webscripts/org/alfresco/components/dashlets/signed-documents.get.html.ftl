   ...
   <@uniqueIdDiv>
      ...
      <div class="dashlet signed-documents">
         ...
         <div class="toolbar flat-button">
            <div class="hidden">
               <span class="align-left yui-button yui-menu-button" id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-user">
                  <span class="first-child">
                     <button type="button" tabindex="0"></button>
                  </span>
               </span>
               <select id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-user-menu">
               <#list filterTypes as filter>
                  <option value="${filter.type?html}">${msg("filter." + filter.label)}</option>
               </#list>
               </select>
               <span class="align-left yui-button yui-menu-button" id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-range">
                  <span class="first-child">
                     <button type="button" tabindex="0"></button>
                  </span>
               </span>
               <select id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-range-menu">
               <#list filterRanges as filter>
                  <option value="${filter.type?html}">${msg("filter." + filter.label)}</option>
               </#list>
               </select>
               <div id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-simpleDetailed" class="align-right simple-detailed yui-buttongroup inline">
         ...
         <div class="body scrollableList" <#if args.height??>style="height: ${args.height}px;"</#if>>
            <div id="com.alfresco.plugin:digitalSigningShare:jar:1.2.1-documents"></div>
         </div>
      </div>
   </@>
</@>