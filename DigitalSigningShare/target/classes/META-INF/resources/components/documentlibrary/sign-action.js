(function()
{
	...
	YAHOO.Bubbling.fire("registerAction",
	{
		...
		fn: function DL_onActionSign(record)
		{
		 ...
		 {
		    width: "50em",
		    templateUrl: Alfresco.constants.URL_SERVICECONTEXT + "modules/digitalSigning/sign?displayName=" + encodeURIComponent(displayName) + "&nodeRef=" + encodeURIComponent(nodesRef.join()) + "&multiple=" + multiple,
		    actionUrl: actionUrl,
